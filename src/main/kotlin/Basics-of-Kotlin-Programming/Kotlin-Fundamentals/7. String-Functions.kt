...
fun main() {
    ...
    // String length/length: Returns the length of the strin
    ...
    //indexOf: Finds the index of the first occurrence of a substring. Get the starting index of a character
    val getIndexOfSentence = sentence.indexOf('A')

    //lastIndexOf: Finds the index of the last occurrence of a substring. Get the lastIndexOf of a character
   ...
   // CompareTo Functions - compareTo: Compares two strings lexicographically.
 ...
 // equals() Function
  ...
  println(ansCheck1)
    ...
    //isEmpty: Checks if the string is empty. isEmpty() string function
    ...
    //isNotEmpty: Checks if the string is not empty. isNotEmpty() string function
    ...
    //startsWith: Checks if the string starts with a specific prefix. startsWith() string function
    ...
    //endsWith: Checks if the string ends with a specific suffix. endsWith() string function
    ...
    //substring: Returns a portion of the string. substring() string function
    ...
    //toUpperCase: Converts the string to uppercase. toUpperCase string function
   ...
   //toLowerCase: Converts the string to lowercase. toLowerCase() string function
    ...
    //trim: Removes leading and trailing whitespace. trim() function
   ...
   // Remove hyphens and " is fun" from both ends
    ...
    //split: Splits the string into a list of substrings based on a delimiter. spilt()
    ...
    //toInt, toDouble, toFloat: Converts a string to an integer, double, or float, respectively. toInt(), toFloat(), toDouble()
    ...
    //replace: Replaces all occurrences of a substring with another. replace string function
    ...
    //format: Formats a string using placeholders. format function
   ...
   //contains: Checks if the string contains a specific substring. (contains function)
    ...
    //matches: Checks if the string matches a regular expression. (matches string function)
